...
export default function NewProduct() {
  ...
  return (
    <>
      ...
      <h1 className="mt-4 text-2xl font-bold text-navy dark:text-white">새 제품</h1>
      <form onSubmit={handleSubmit} className="mt-6 max-w-xl space-y-4">
        ...
        <label className="block">
          ...
          <input value={category} onChange={(e) => setCategory(e.target.value)} required className={inputClass} placeholder="웹, 앱" />
        </label>
        <label className="block">
